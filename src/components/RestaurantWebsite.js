        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="md:hidden mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a href={`tel:${id.contact1}`} className="flex items-center text-red-600 hover:text-red-800">
              ...
              {contact2 && (
                <div className="border rounded-lg p-3 text-center">
                  <a href={`tel:${id.contact2}`} className="flex items-center text-red-600 hover:text-red-800">
                    <Phone className="w-4 h-4 mr-2" />
                    {contact2}
                  </a>
                </div>
